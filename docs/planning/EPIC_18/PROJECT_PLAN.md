...
additional allocation-failure proof, remaining large review surfaces, cross-platform
...
- reduce one additional high-risk review surface while keeping broader
  review-surface cleanup scoped to later selected clusters;
...
## Epic 18 Current Status Snapshot

This snapshot began with `SPRINT_197/artifacts/day8-project-plan-status.md`
as an interim evidence ledger. Sprint 197 remains historical final-validation
evidence with an explicit numbering caveat: it was requested under
`SPRINT_197`, but the cited final-validation item numbers belong to this
project plan's Sprint 206 section.

Sprints 198 through 205 now have their own merged plans, working notes,
retrospectives, daily artifacts, validation records, and PR evidence recorded
below. Sprint 206 is the explicit current closeout branch and is closed
through Day 14. This snapshot distinguishes selected closures and re-deferrals
from broad package, Windows, ABI, generated API publication, portable
performance, release, and state-of-the-art claims, which remain unearned unless
exact evidence is recorded.

| Sprint | Current disposition | Evidence |
| --- | --- | --- |
| 197 | Historical final-validation evidence with numbering caveat | `SPRINT_197/PLAN.md`; `SPRINT_197/WORKING_NOTES.md`; `SPRINT_197/RETROSPECTIVE.md`; `SPRINT_197/artifacts/day1-closeout-intake.md` through `SPRINT_197/artifacts/day14-final-closeout-review.md`; useful as requested-branch final-validation evidence, but no longer the current explicit Sprint 206 closeout path. |
| 198 | Closed with developer-mode local Homebrew static source proof | `SPRINT_198/PLAN.md`; `SPRINT_198/WORKING_NOTES.md`; `SPRINT_198/artifacts/day1-package-metadata-intake.md`; `SPRINT_198/artifacts/day2-license-metadata-decision.md`; `SPRINT_198/artifacts/day3-root-metadata-implementation.md`; `SPRINT_198/artifacts/day4-formula-metadata-wiring.md`; `SPRINT_198/artifacts/day5-archive-checksum-proof.md`; `SPRINT_198/artifacts/day6-formula-render-validation.md`; `SPRINT_198/artifacts/day7-install-surface-proof.md`; `SPRINT_198/artifacts/day8-downstream-formula-test-proof.md`; `SPRINT_198/artifacts/day9-end-to-end-proof-run.md`; `SPRINT_198/artifacts/day10-package-guard-promotion.md`; `SPRINT_198/artifacts/day11-public-package-docs.md`; `SPRINT_198/artifacts/day12-maintainer-planning-alignment.md`; `SPRINT_198/artifacts/day13-integrated-validation.md`; `SPRINT_198/artifacts/day14-closeout-review.md`; root MIT metadata and `HOMEBREW_DEVELOPER=1 SPARSE_HOMEBREW_LICENSE=MIT` are present, and the recorded macOS Intel x86_64 Tier 3 Homebrew proof reaches archive/checksum/temporary-tap render, source install, installed static package surface validation, downstream `brew test`, uninstall, cleanup, and proof exit `0`; broad package-manager support, Homebrew/core readiness, bottles, Linuxbrew, public tap maintenance, and binary package distribution remain unclaimed. |
| 199 | Closed with Windows promotion re-deferred | `SPRINT_199/PLAN.md`; `SPRINT_199/WORKING_NOTES.md`; `SPRINT_199/artifacts/day1-windows-freshness-intake.md`; `SPRINT_199/artifacts/day2-hosted-artifact-inventory.md`; `SPRINT_199/artifacts/day3-evidence-semantics.md`; `SPRINT_199/artifacts/day4-manifest-decision.md`; `SPRINT_199/artifacts/day5-windows-path-normalization-tests.md`; `SPRINT_199/artifacts/day6-freshness-diagnostics.md`; `SPRINT_199/artifacts/day7-normalizer-hardening.md`; `SPRINT_199/artifacts/day8-workflow-alignment.md`; `SPRINT_199/artifacts/day9-powershell-guard.md`; `SPRINT_199/artifacts/day10-gate-integration.md`; `SPRINT_199/artifacts/day11-public-docs.md`; `SPRINT_199/artifacts/day12-maintainer-planning-alignment.md`; `SPRINT_199/artifacts/day13-integrated-validation.md`; `SPRINT_199/artifacts/day14-closeout-review.md`; hosted Windows evidence for `cholesky-spd-tridiag-5` was reviewed and retained as guarded workflow evidence, while selected Windows freshness promotion remains re-deferred until selected metadata, generated support tier, generated non-claim wording, and final claim contract are promoted together. |
| 200 | Closed with selected symbolic LU allocation-failure proof | `SPRINT_200/PLAN.md`; `SPRINT_200/WORKING_NOTES.md`; `SPRINT_200/artifacts/day1-candidate-intake.md`; `SPRINT_200/artifacts/day2-owner-selection.md`; `SPRINT_200/artifacts/day3-lifecycle-trace.md`; `SPRINT_200/artifacts/day4-invariant-record.md`; `SPRINT_200/artifacts/day5-harness-design.md`; `SPRINT_200/artifacts/day6-harness-integration.md`; `SPRINT_200/artifacts/day7-failed-allocation-tests.md`; `SPRINT_200/artifacts/day8-cleanup-proof.md`; `SPRINT_200/artifacts/day9-retry-proof.md`; `SPRINT_200/artifacts/day10-focused-gate.md`; `SPRINT_200/artifacts/day11-claim-documentation.md`; `SPRINT_200/artifacts/day12-integrated-validation.md`; `SPRINT_200/artifacts/day13-review-hardening.md`; `SPRINT_200/artifacts/day14-closeout-review.md`; selected `sparse_symbolic_lu()` allocation-failure proof, focused gate, registration guard, claim-safe docs, integrated validation, review-hardening traceability, and final closeout are present; broad allocation-failure, platform, package/install, generated-tooling, hosted CI, OS OOM, concurrent hook, and state-of-the-art reliability claims remain unclaimed. |
| 201 | Closed for selected SVD helper review-surface reduction | `SPRINT_201/PLAN.md`; `SPRINT_201/WORKING_NOTES.md`; `SPRINT_201/artifacts/day1-large-surface-intake.md`; `SPRINT_201/artifacts/day2-candidate-ranking.md`; `SPRINT_201/artifacts/day3-selected-cluster-boundary.md`; `SPRINT_201/artifacts/day4-preservation-invariants.md`; `SPRINT_201/artifacts/day5-extraction-design.md`; `SPRINT_201/artifacts/day6-first-extraction-pass.md`; `SPRINT_201/artifacts/day7-cohesion-pass.md`; `SPRINT_201/artifacts/day8-registration-alignment.md`; `SPRINT_201/artifacts/day9-ownership-guard.md`; `SPRINT_201/artifacts/day10-focused-regression.md`; `SPRINT_201/artifacts/day11-maintainer-alignment.md`; `SPRINT_201/artifacts/day12-integrated-validation.md`; `SPRINT_201/artifacts/day13-review-hardening.md`; `SPRINT_201/artifacts/day14-closeout-review.md`; the selected `tests/test_svd.c` rank, pseudoinverse, and dense low-rank cluster is helper-owned by `tests/test_svd_selected_helpers.h`, while `tests/test_svd_helpers.h` remains shared fixture support; `make svd-helper-guard` and `python3 tests/test_svd_helper_guard.py` protect selected-helper dependencies, frozen `RUN_TEST(...)` order, explicit Makefile prerequisites, and header-only registration boundaries; Day 12 validated `make format && make lint && make test`, and the review fix revalidates the focused SVD guard path; broad SVD behavior, partial-SVD ownership, public API/ABI, performance, platform, package, and repository-wide review-surface cleanup remain unclaimed. |
| 202 | Closed with macOS hosted selected benchmark freshness evidence | `SPRINT_202/PLAN.md`; `SPRINT_202/WORKING_NOTES.md`; `SPRINT_202/RETROSPECTIVE.md`; `SPRINT_202/artifacts/day1-benchmark-freshness-intake.md`; `SPRINT_202/artifacts/day2-platform-row-ranking.md`; `SPRINT_202/artifacts/day3-selected-lane-decision.md`; `SPRINT_202/artifacts/day4-methodology-metadata-contract.md`; `SPRINT_202/artifacts/day5-validator-manifest-design.md`; `SPRINT_202/artifacts/day6-freshness-validator-implementation.md`; `SPRINT_202/artifacts/day7-freshness-regression-fixtures.md`; `SPRINT_202/artifacts/day8-hosted-workflow-lane.md`; `SPRINT_202/artifacts/day9-workflow-guard-local-simulation.md`; `SPRINT_202/artifacts/day10-documentation-calibration.md`; `SPRINT_202/artifacts/day11-focused-freshness-validation.md`; `SPRINT_202/artifacts/day12-integrated-validation-hosted-evidence.md`; `SPRINT_202/artifacts/day13-review-hardening.md`; `SPRINT_202/artifacts/day14-closeout-retrospective-inputs.md`; PR run `34517520951`, job `103006563210`, passed the macOS hosted selected-performance freshness lane for `SRT-BENCH-REFACTOR-CSC-NOS4` on commit `52890043be0d2325f2e4534a480d5f1cfc7ce23e`; artifact `sprint202-macos-selected-performance-freshness` id `10168283869` uploaded exactly `bench_refactor_csc.csv`, `index.tsv`, and `manifest.txt`; digest `sha256:308ee8f780a28673fc02ff40b10aeb17ae6219fcdf55095657526b76f7016af4`; portable performance, timing thresholds, Windows selected benchmark freshness, broad benchmark publication, package support, release readiness, and state-of-the-art performance remain unclaimed. |
| 203 | Closed with Windows QR incompatible promotion re-deferred | `SPRINT_203/PLAN.md`; `SPRINT_203/WORKING_NOTES.md`; `SPRINT_203/RETROSPECTIVE.md`; `SPRINT_203/artifacts/day1-windows-qr-intake.md`; `SPRINT_203/artifacts/day2-msvc-probe-design.md`; `SPRINT_203/artifacts/day3-probe-execution-record.md`; `SPRINT_203/artifacts/day4-generator-cmake-fix-design.md`; `SPRINT_203/artifacts/day5-selected-generator-fixes.md`; `SPRINT_203/artifacts/day6-artifact-path-row-filtering-tests.md`; `SPRINT_203/artifacts/day7-manifest-promotion-decision.md`; `SPRINT_203/artifacts/day8-manifest-workflow-metadata.md`; `SPRINT_203/artifacts/day9-workflow-guard-integration.md`; `SPRINT_203/artifacts/day10-normalizer-freshness-diagnostics.md`; `SPRINT_203/artifacts/day11-documentation-calibration.md`; `SPRINT_203/artifacts/day12-integrated-validation.md`; `SPRINT_203/artifacts/day13-review-hardening.md`; `SPRINT_203/artifacts/day14-closeout-review.md`; local `qr-incompatible-ls` generator and selected freshness proof passed, Windows-style artifact path and diagnostic guards were added, docs and claim-boundary guards were calibrated, and workflow/selected manifest promotion remained intentionally absent because hosted Windows/MSVC proof and hosted artifact inspection were not available. |
| 204 | Closed with stronger local-only generated API policy | `SPRINT_204/PLAN.md`; `SPRINT_204/WORKING_NOTES.md`; `SPRINT_204/RETROSPECTIVE.md`; `SPRINT_204/artifacts/day1-generated-api-intake.md`; `SPRINT_204/artifacts/day2-current-doxygen-baseline.md`; `SPRINT_204/artifacts/day3-publication-option-inventory.md`; `SPRINT_204/artifacts/day4-decision-criteria-acceptance-gate.md`; `SPRINT_204/artifacts/day5-product-decision.md`; `SPRINT_204/artifacts/day6-workflow-tracking-design.md`; `SPRINT_204/artifacts/day7-policy-implementation-batch.md`; `SPRINT_204/artifacts/day8-freshness-and-coverage-checks.md`; `SPRINT_204/artifacts/day9-link-and-routing-validation.md`; `SPRINT_204/artifacts/day10-user-facing-api-docs-update.md`; `SPRINT_204/artifacts/day11-maintainer-and-claim-boundary-docs.md`; `SPRINT_204/artifacts/day12-integrated-validation.md`; `SPRINT_204/artifacts/day13-review-hardening.md`; `SPRINT_204/artifacts/day14-closeout-review.md`; generated Doxygen HTML remains local-only ignored output under `docs/api/html/`, `make api-docs-freshness` now covers generated-page freshness, local-only staging, workflow non-publication, API routing, and Makefile routing wiring, while hosted generated API publication, retained generated-doc artifacts, committed generated HTML, package-manager evidence, ABI/shared-library evidence, broad platform evidence, performance evidence, release evidence, and state-of-the-art evidence remain unclaimed. |
| 205 | Closed with support matrix and adoption quick-reference consolidation | `SPRINT_205/PLAN.md`; `SPRINT_205/WORKING_NOTES.md`; `SPRINT_205/RETROSPECTIVE.md`; `SPRINT_205/artifacts/day1-support-intake.md`; `SPRINT_205/artifacts/day2-public-doc-audit.md`; `SPRINT_205/artifacts/day3-maintainer-report-audit.md`; `SPRINT_205/artifacts/day4-quick-reference-design.md`; `SPRINT_205/artifacts/day5-support-truth-architecture.md`; `SPRINT_205/artifacts/day6-quick-reference-implementation.md`; `SPRINT_205/artifacts/day7-support-truth-consolidation.md`; `SPRINT_205/artifacts/day8-example-workflow-routing.md`; `SPRINT_205/artifacts/day9-diagnostics-vocabulary-design.md`; `SPRINT_205/artifacts/day10-diagnostics-vocabulary-implementation.md`; `SPRINT_205/artifacts/day11-claim-guard-design.md`; `SPRINT_205/artifacts/day12-claim-guard-implementation.md`; `SPRINT_205/artifacts/day13-integrated-validation.md`; `SPRINT_205/artifacts/day14-closeout-review.md`; public support truth remains `INSTALL.md#support-readiness-matrix`, the compact problem-shape quick reference routes users to existing solver/workflow owners, diagnostics wording was normalized across selected docs, and focused claim guards were aligned with simplified wording while package-manager, Windows, ABI/shared-library, hosted generated API, portable performance, release, and state-of-the-art claims remain unclaimed. |
| 206 | Closed with Epic 18 final validation, claim calibration, residual handoff, and closeout | `SPRINT_206/PLAN.md`; `SPRINT_206/WORKING_NOTES.md`; `SPRINT_206/artifacts/day1-closeout-intake.md`; `SPRINT_206/artifacts/day2-outcome-reconciliation.md`; `SPRINT_206/artifacts/day3-claim-surface-audit.md`; `SPRINT_206/artifacts/day4-project-plan-status-design.md`; `SPRINT_206/artifacts/day5-public-claim-update.md`; `SPRINT_206/artifacts/day6-maintainer-claim-update.md`; `SPRINT_206/artifacts/day7-project-plan-status-implementation.md`; `SPRINT_206/artifacts/day8-validation-scope-design.md`; `SPRINT_206/artifacts/day9-focused-validation.md`; `SPRINT_206/artifacts/day10-broad-quality-gates.md`; `SPRINT_206/artifacts/day11-epic-retrospective-draft.md`; `SPRINT_206/artifacts/day12-residual-queue-draft.md`; `SPRINT_206/artifacts/day13-consistency-hardening.md`; `SPRINT_206/artifacts/day14-closeout-review.md`; evidence reconciliation, public and maintainer claim recalibration, project-plan status implementation, validation scope design, focused validation, broad documentation/API validation, Epic retrospective, residual queue, consistency hardening, and final closeout review are complete; broad package, Windows, ABI/shared-library, hosted generated API, portable performance, release, ecosystem parity, and state-of-the-art claims remain unearned unless exact future evidence is recorded. |

Historical item-level disposition evidence remains in
`SPRINT_197/artifacts/day8-project-plan-status.md`. Current Sprint 206 status
implementation evidence begins with
`SPRINT_206/artifacts/day2-outcome-reconciliation.md` and
`SPRINT_206/artifacts/day7-project-plan-status-implementation.md`; Day 8
validation-scope evidence is recorded in
`SPRINT_206/artifacts/day8-validation-scope-design.md`; Day 9 focused
validation evidence is recorded in
`SPRINT_206/artifacts/day9-focused-validation.md`; Day 10 broad validation
evidence is recorded in
`SPRINT_206/artifacts/day10-broad-quality-gates.md`; Day 11 retrospective
draft evidence is recorded in
`SPRINT_206/artifacts/day11-epic-retrospective-draft.md`; Day 12 residual
queue evidence is recorded in
`SPRINT_206/artifacts/day12-residual-queue-draft.md`; Day 13 consistency
hardening evidence is recorded in
`SPRINT_206/artifacts/day13-consistency-hardening.md`; Day 14 closeout review
evidence is recorded in
`SPRINT_206/artifacts/day14-closeout-review.md`.
