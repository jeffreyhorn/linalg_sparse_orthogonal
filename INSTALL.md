...
| Package-manager distribution | not claimed | Use source install via Make or CMake | Sprint 198 Homebrew proof material, package-manager deferral guard | No Homebrew/core, bottles, Linuxbrew, tap, vcpkg, Conan, pkgsrc, distro/system package, or broad provider support. |
