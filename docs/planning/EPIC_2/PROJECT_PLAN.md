# Project Plan: linalg_sparse_orthogonal -- Sprints 11-28 (Epic 2)
...
## Sprint 28: SVD Improvements, Eigenpair Refinement, Progress Callbacks, CI Hardening & Epic 2 Wrap-Up
...
- Sprints 11–27: all Epic 2 numeric, eigensolver, and ordering features complete (Sprint 22 ordering stack + Sprint 23 ordering-quality follow-ups + Sprint 24 ordering deferrals + Sprint 25 ND fill-quality follow-ups + Sprint 26 ND fill-quality closure + Sprint 27 ND fill-quality closure II) — needed for the final regression pass, cross-feature integration tests, and README/retrospective sweep.
...
| 28 | SVD, Progress Callbacks, Eigenpair Refinement, CI & Wrap-Up | Sparse low-rank fix, full SVD, eigenpair iterative refinement, progress/cancel callbacks, Windows/macOS CI, coverage-gate calibration, CI bench-step fix, Epic 2 retrospective | 168 hrs |

**Total Epic 2 estimate:** ~2,436 hours across 18 sprints (~243 days)
