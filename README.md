...
- **Fill-reducing reordering** — Reverse Cuthill-McKee (RCM), Approximate Minimum Degree (AMD), Nested Dissection (ND, multilevel vertex separator — best on 2D / 3D PDE meshes), and Column Approximate Minimum Degree (COLAMD) for unsymmetric/QR problems
