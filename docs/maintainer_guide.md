...
- Sprints 121-125 add bounded QR, SVD, and partial-SVD evidence lanes, but
  those lanes prove only the named fixtures and owner-local behaviors listed
  above.
