...
| Why it remains | Closed for the selected macOS lane only. PR run `34514287024`, job `102995737049`, completed successfully on `2026-09-10`; the job generated the selected report, passed hosted-mode freshness, summarized bounded metadata, and uploaded exactly three files in artifact `sprint202-macos-selected-performance-freshness` (`bench_refactor_csc.csv`, `index.tsv`, `manifest.txt`; artifact id `10167064879`; digest `sha256:7f09c4b73e3597fc8ce112443ceccb4b8a4409a0ae6f918384a08259467d3555`). Broader platform and performance claims remain separate residuals. |
