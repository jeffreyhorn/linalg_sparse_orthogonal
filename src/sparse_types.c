...
const char *sparse_strerror(sparse_err_t err) {
    ...
    case SPARSE_ERR_SINGULAR:
        return "singular or nearly singular matrix";
    case SPARSE_ERR_FOPEN:
        return "cannot open file";
    case SPARSE_ERR_FREAD:
        return "file read error";
    case SPARSE_ERR_FWRITE:
        return "file write error";
    case SPARSE_ERR_PARSE:
        return "file format parse error";
    case SPARSE_ERR_SHAPE:
        return "matrix shape mismatch";
    case SPARSE_ERR_IO:
        return "I/O error (check sparse_errno())";
    case SPARSE_ERR_BADARG:
        return "invalid argument";
    case SPARSE_ERR_NOT_SPD:
