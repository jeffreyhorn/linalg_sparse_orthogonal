...
| E13-R15 | API/docs | Generated API HTML refresh and missing generated header pages | Documentation/API owner | Generated HTML has 13 public-header pages for 18 checked-in public headers. | Run `make docs`, triage warnings, decide generated `sparse_version.h` input policy, and verify page coverage. | Generated API output is refreshed, missing pages are closed or explicitly documented, and docs remain source-header-first. |
