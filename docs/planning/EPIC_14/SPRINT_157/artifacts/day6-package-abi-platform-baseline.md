...
| Installed public headers | `include/*.h`, generated `sparse_version.h` from `include/sparse_version.h.in` | Install scripts check 19 installed headers | Installed headers are public package surface; header presence is not a dynamic ABI guarantee. |
