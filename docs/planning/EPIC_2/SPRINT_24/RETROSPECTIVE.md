...
4. **CI gate calibration (Days 12-13).**  Two long-standing CI
   failures inherited and re-confirmed on PR #32 (neither
   Sprint-24-introduced):
   - `coverage` gate fails at 80.8 % aggregate vs 95 % threshold;
