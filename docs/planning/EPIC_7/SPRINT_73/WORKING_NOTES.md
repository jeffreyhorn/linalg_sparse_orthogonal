...
## Sprint 73 Day 13: Validation Sweep
...
The touched Sprint 73 follow-ons also all passed:
...
- install/package regressions retained installed `pkg-config` version `2.2.0`
