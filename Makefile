...
LIB_SRCS = $(SRCDIR)/sparse_types.c \
           ...
           $(SRCDIR)/sparse_matrix_build_internal.c \
           $(SRCDIR)/sparse_matrix_io.c \
           $(SRCDIR)/sparse_factor_state_internal.c \
           ...
           $(SRCDIR)/sparse_eigs_selection_internal.c \
...
TEST_SRCS = $(TESTDIR)/test_sparse_matrix.c \
            ...
            $(TESTDIR)/test_framework_optin.c \
...
.PHONY: docs api-docs-coverage api-docs-local-only api-docs-routing qr-header-docs-guard docs-check api-docs-validate api-docs-freshness
docs:
